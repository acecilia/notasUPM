...
- (void)setup
{
	...
	self.shouldAddPanGestureRecognizerToTopViewSnapshot = YES;//modificado del original: añade reconocimiento del gesto de deslizar para cerrar el lateral
...
- (void)setUnderLeftViewController:(UIViewController *)theUnderLeftViewController
{
	...
	if (_underLeftViewController) {
		...
		[self.view insertSubview:_underLeftViewController.view atIndex:0]; //modificado del original: añadido
	}
}
